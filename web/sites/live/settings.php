 ...
 * @endcode
 */
$settings['hash_salt'] = 'AISqzEd51OYakTOeQvOm4Kj0w72Uj0dKBKzY8tozh_ZYkZgPf2moL9Sx7XqWqrg_MybaSvltew';
 ...
 */
$settings['trusted_host_patterns'] = array(
  '^((ru|en|uk)\.)?(www\.)?ukravtonomgaz\.ua$',
  '^((ru|en|uk)\.)?(www\.)?stage\.ukravtonomgaz\.ua$',
 );
/**
...
$config['environment_indicator.indicator']['bg_color'] = '#FF6B6B';
$config['environment_indicator.indicator']['fg_color'] = '#FFFFFF';
$config['environment_indicator.indicator']['name'] = 'Live';
$config['environment_indicator.indicator']['id'] = 'live';
